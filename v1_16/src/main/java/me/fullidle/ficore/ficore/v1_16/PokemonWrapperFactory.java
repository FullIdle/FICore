...
public class PokemonWrapperFactory implements IPokemonWrapperFactory<Pokemon> {
    ...
    public static class PokemonWrapper extends IPokemonWrapper<Pokemon> {
        ...
        public List<Element> getTypes() {
            return this.getOriginal().getForm().getTypes().stream().map(e->Element.fromString(e.name())).collect(Collectors.toList());
        }
        ...
        public IPokemonWrapper<?> copy() {
            val copy = PokemonFactory.create(this.getOriginal().writeToNBT(new CompoundNBT()));
        ...
        public String serialize() {
            return this.getOriginal().writeToNBT(new CompoundNBT()).toString();
        }
        ...
        public IMoveWrapper<?>[] getMoves() {
            val moveset = getOriginal().getMoveset();
